...
extern enum MOTORstate MRstate;
extern enum SYSmode lpm_mode; // global variable
extern unsigned int delay_time;
extern int flag_push;
extern int flag_send;
extern short flag_MSB;
extern short flag_state;
extern const short state_changed[];
extern char stringFromPC[];
extern char file_content[];
extern int flag_execute;
extern int flag_flashburn;
extern int SendFlag;
extern int j;
extern short Vr[];
extern int counter;
extern int flag_rotate;
...
extern void go_to_position(uint32_t stepper_degrees, char script_state);
extern int16_t calc_angle(int16_t y_fp, int16_t x_fp);
